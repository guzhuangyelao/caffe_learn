...
class Person_PhoneNumber : public ::google::protobuf::Message {
 public:
  ...
  // optional .tutorial.Person.PhoneType type = 1 [default = Home];
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  static const int kHomeFieldNumber = 2;
...
inline const ::std::string& Person::home() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.home)
  return *home_;
}
inline void Person::set_home(const ::std::string& value) {
  set_has_home();
  if (home_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    home_ = new ::std::string;
  }
  home_->assign(value);
  // @@protoc_insertion_point(field_set:tutorial.Person.home)
}
inline void Person::set_home(const char* value) {
  set_has_home();
  if (home_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    home_ = new ::std::string;
  }
  home_->assign(value);
  // @@protoc_insertion_point(field_set_char:tutorial.Person.home)
}
inline void Person::set_home(const char* value, size_t size) {
  set_has_home();
  if (home_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    home_ = new ::std::string;
  }
  home_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tutorial.Person.home)
}
inline ::std::string* Person::mutable_home() {
  set_has_home();
  if (home_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    home_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:tutorial.Person.home)
  return home_;
}
inline ::std::string* Person::release_home() {
  clear_has_home();
  if (home_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void Person::set_allocated_home(::std::string* home) {
  if (home_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete home_;
  }
  if (home) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tutorial.Person.home)
}
